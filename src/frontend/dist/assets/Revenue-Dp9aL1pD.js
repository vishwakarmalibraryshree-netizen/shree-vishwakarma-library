import { c as createLucideIcon, n as commonjsGlobal, o as getDefaultExportFromCjs, r as reactExports, p as React, q as invariant, j as jsxRuntimeExports, T as TrendingUp } from "./index-BxMJF1mf.js";
...
import { x as useTotalRevenue, y as useRevenueByPaymentType, z as useRevenueChart, j as useMonthlyRevenue } from "./types-CeHNxeEG.js";
...
function RevenueTooltip({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-lg p-3 shadow-elevated text-xs", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground mb-1", children: label }),
    payload.map((p2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { color: p2.color }, children: [
      p2.name,
      ": ₹",
      p2.value.toLocaleString("en-IN")
    ] }, p2.name))
  ] });
}
function buildChartData(data) {
  return data.slice(-30).map((d2) => ({
    date: d2.date.split("-").slice(1).join("/"),
    Cash: Number(d2.cashAmount),
    Online: Number(d2.onlineAmount),
    total: Number(d2.total)
  }));
}
function SummaryCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border border-border shadow-warm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5 flex items-center gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: `w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 ${accent ? "bg-accent/15 text-accent-foreground" : "bg-primary/10 text-primary"}`,
        children: icon
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
      ...
      isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-8 w-24 mt-1" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "p",
        {
...
function AdminRevenue() {
  ...
  const years = Array.from({ length: 5 }, (_, i) => now2.getFullYear() - i);
  const grandTotal = Number((byType == null ? void 0 : byType.grandTotal) ?? 1);
  const barData = chart ? buildChartData(chart) : [];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", "data-ocid": "admin.revenue.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "gradient-warm px-6 py-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-primary-foreground/70 mt-0.5", children: "Complete financial overview — daily trends, monthly totals, and payment breakdown" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 py-6 space-y-6", children: [
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              SummaryCard,
              {
                ...
                icon: /* @__PURE__ */ jsxRuntimeExports.jsx(IndianRupee, { size: 22 }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              {
                label: "Cash Revenue",
                value: byType == null ? void 0 : byType.cashTotal,
                isLoading: byTypeLoading,
                icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Banknote, { size: 22 }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              SummaryCard,
              {
                ...
                value: byType == null ? void 0 : byType.onlineTotal,
                isLoading: byTypeLoading,
                icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CreditCard, { size: 22 }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Card,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base font-semibold text-foreground", children: "Monthly Revenue" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "select",
                  {
                    ...
                    value: year,
                    onChange: (e3) => setYear(Number(e3.target.value)),
                    ...
                    children: years.map((y2) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: y2, children: y2 }, y2))
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "select",
                  {
                    ...
                    value: month,
                    onChange: (e3) => setMonth(Number(e3.target.value)),
                    className: "px-3 py-1.5 bg-background border border-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-ring transition-smooth",
                    children: MONTHS.map((m2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: i + 1, children: m2 }, m2))
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-auto", children: monthlyLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-10 w-28" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Card,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base font-semibold text-foreground", children: "Daily Revenue — Last 30 Days" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-5", children: chartLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              Skeleton,
              {
                className: "h-72 w-full",
                "data-ocid": "revenue.chart.loading_state"
              }
            ) : barData.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 290, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              BarChart,
              {
                data: barData,
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    YAxis,
                    {
                      ...
                      tickFormatter: (v2) => `₹${v2.toLocaleString("en-IN")}`,
                      axisLine: false,
                      tickLine: false,
                      label: {
                        value: "Amount (₹)",
              ...
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center text-muted-foreground", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { size: 48, className: "mx-auto mb-3 opacity-30" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "No revenue data available yet" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-1", children: "Data will appear once fees are collected" })
                ] })
              }
            ) })
          ]
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Card,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base font-semibold text-foreground", children: "Cash vs Online Payment Breakdown" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-5", children: byTypeLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-52 w-full" }) : pieData.every((d2) => d2.value === 0) ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CreditCard, { size: 36, className: "mx-auto mb-2 opacity-30" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No payment data available" })
                ] })
              }
            ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center gap-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: 220, height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Pie,
                  {
                    data: pieData,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 flex-1 w-full", children: [
                pieData.map((d2) => {
                  const pct = grandTotal > 0 ? Math.round(d2.value / grandTotal * 100) : 0;
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 bg-muted rounded-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-3 border-t border-border flex justify-between items-center", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "span",
                    {
                      ...
                      children: [
                        "₹",
                        Number((byType == null ? void 0 : byType.grandTotal) ?? 0).toLocaleString("en-IN")
                      ]
                    }
                  )
                ] })
